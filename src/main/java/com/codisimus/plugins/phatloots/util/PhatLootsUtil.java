...
public class PhatLootsUtil {
    ...
    public static String getItemName(ItemStack item) {
        ...
        //A display name was not found so use a cleaned up version of the ItemStack
        Component translatableName = Component.translatable(item);
        return PlainTextComponentSerializer.plainText().serialize(translatableName);
    }
    ...
    public static String getBlockName(Block block) {
        //Return the Display name of the item if there is one
        //A display name was not found so use a cleaned up version of the Block
        Component translatableName = Component.translatable(block);
        return PlainTextComponentSerializer.plainText().serialize(translatableName);
    }
